...
class CandidateSmasher():
    ...
    def __init__(self, input_string: str = "{}", templates_src: typing.Optional[str] = None):
        try:
            self._spek_hsh = json.loads(input_string)  # is a dict
        except json.decoder.JSONDecodeError:
            self._spek_hsh = {}
        self._template_lib = self.load_ext_templates(templates_src)  # is a list of dicts
